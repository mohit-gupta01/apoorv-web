    ...
    return (
        <div id='about'>
            <div className="flex flex-row justify-between items-center">
                ...
                <div className="flex flex-col items-center m-10 md:m-0 lg:mr-[20px] xl:mr-[80px] gap-5">
                    <h1 className='poppins-bold text-5xl xl:text-[74px] lg:text-[55px] md:text-[40px]'>About</h1>
                    <p className='poppins-medium text-xl xl:text-[24px] lg:text-[20px] md:text-[18px] text-[16px] xl:w-[650px] md:w-[350px] text-center'>
