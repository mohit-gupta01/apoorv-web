    ...
    return (
        <div className='flex flex-row items-center justify-between lg:mt-[0px] mt-[120px]'>
            <div className='z-50 flex flex-col ml-[20px] xl:ml-[200px] md:ml-10 gap-1 h-[80vh] md:h-fit'>
                ...
                <p className='poppins-regular text-[#000000] lg:text-[16px] md:text-[14px] text-[14px] xl:w-[500px] lg:w-[450px] md:[350px] w-[350px] tracking-wide leading-6 font-medium'>A fest that celebrates both the innumerous shades of our culture and the bluey horizons of technology with a tint of literature in it too.</p>
