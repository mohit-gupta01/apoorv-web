    ...
    <div className="sponsor relative">
      <div className="relative">
        <div className="mt-[115px]">
          ...
          <p className="flex flex-wrap border-box poppins-regular absolute top-[495px] text-[#000000] font-medium text-[36px] leading-10 xl:w-[650px] lg:w-[600px] md:w-[550px] sm:w-[400px] w-[350px] text-[#E5D1A6]  ml-[52px] text-justify para">
